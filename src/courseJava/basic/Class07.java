...
public class Class07 {
	public static void main(String[] args) throws ParseException {
		// DATE
		/*
		 * //formatos de data e hora SimpleDateFormat sdf1 = new
		 * SimpleDateFormat("dd/MM/yyyy"); SimpleDateFormat sdf2 = new
		 * SimpleDateFormat("dd/MM/yyyy HH:mm:ss"); SimpleDateFormat sdf3 = new
		 * SimpleDateFormat("dd/MM/yyyy HH:mm:ss");
		 * sdf3.setTimeZone(TimeZone.getTimeZone("GMT")); //Definir horário padrão de
		 * Local
		 * 
		 * //Instâncias Date x1 = new Date(); Date x2 = new
		 * Date(System.currentTimeMillis()); Date x3 = new Date(0L); //Primeiro horário
		 * armazenado(3 horas atrasado) Date x4 = new Date(1000L * 60L * 60L *8L);
		 * //Remover manualmentee atraso
		 * 
		 * Date y1 = sdf1.parse("30/10/2020"); Date y2 =
		 * sdf2.parse("30/10/2020 08:13:00"); Date y3 =
		 * Date.from(Instant.parse("2018-06-25T15:42:07Z")); //ao invés de 15 ira
		...
		// Alterar uantidade de horas
		Calendar cal = Calendar.getInstance();
		cal.setTime(d); //receber instância a ser alterada
		cal.add(Calendar.HOUR_OF_DAY, 4); //add(unidade, quantidade)
		d = cal.getTime(); //alterar instância
		...
		//A contagem dos meses começa a partir de 0 )0-11) por isso soma mais 1
